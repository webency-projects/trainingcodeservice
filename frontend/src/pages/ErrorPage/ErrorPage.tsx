    ...
    return (
        <div className={cls.ErrorPage}>
            <div className={cls.wrapper}>
                ...
                <div>4<NotFoundError/>4</div>
                <Link to={'/'} className={cls.link}>Перейти на главную страницу</Link>
            </div>
        </div>
    )
}
...
const NotFoundError = () => {
    return (
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
             width="100px" height="100px" viewBox="0 0 983.81 983.81">
            <g>
                <path fill="#57eba1" d="M208.854,257.755c-16.4,4-31.7,12.3-44,23.9c-12.7,11.9-22.1,27.1-27.1,44L4.154,778.154c-7.6,25.7-4.7,52.9,8.1,76.5
		...
		C243.455,254.055,225.754,253.555,208.854,257.755z"/>
                <path fill="#57eba1" d="M911.755,80.855l-245.7-72.5c-17.5-5.2-36.101-5.6-53.8-1.3c-17.301,4.3-33.4,13-46.4,25.1c-13.5,12.6-23.4,28.6-28.6,46.3
		...
		c12.7-11.9,22.101-27.1,27.101-44l133.6-452.6c7.601-25.7,4.7-52.9-8.1-76.5C958.755,105.655,937.555,88.455,911.755,80.855z"/>
                <path fill="#ff5c5c" d="M685.354,979.255c9.4,0,18.9-2.9,27-9c19.9-14.9,23.9-43.101,8.9-63l-117-155.5c-14.9-19.9-43.101-23.9-63-8.9
		c-19.9,14.9-23.9,43.101-8.9,63l117,155.5C658.154,973.055,671.654,979.255,685.354,979.255z"/>
                <path fill="#ff5c5c" d="M419.555,249.255c10.399,0,20.899-3.6,29.399-11c18.801-16.3,20.9-44.7,4.601-63.5l-132.601-153.3
